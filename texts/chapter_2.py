...
B = '''{0} сражался отчаянно. Дело в том, что самого детства он ненавидел свой несуразный нос и мечтал
...
Кто-то в толпе предположил, что здесь явно не обошлось без проделок известного маргинала и пакосника {}.
Поддержав справеливость это предположения, собравшиеся начали рыскать глазами по сторонам, пытаясь обнаружить
предполагаемого виновника происшествия.'''.format(CHAR_NAME_1)
...
G = '''Ты вовремя сориентировался и пока мог чувствовать себя в относительной безопасности, поскольку искавшие тебя люди,
ничего не подозревая, проходили мимо и не обращали никакого внимания на ничем не примечательный мешок.
Немного успокоившись, ты уже начал раздумывать, как бы попытаться незаметно улизнуть с площади и убраться куда
подальше, как вдруг двое странного вида {} остановились возле тебя.'''.format(GIPPOGRIF_1)
...
после пинка {}. В этот момент до тебя донеслось чьё-то восклицание: "Смотрите, это же {}!".'''.format(GIPPOGRIF_1, clr.NOSE)
...
K = '''"А вто это уже серьёзно",- подумал ты и затаился, ожидая, что будет дальше.
