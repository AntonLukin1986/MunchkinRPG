...
CHALLENGE = '''Однажды ты уже победил Великого Ктулху. Но если хочешь больше славы - повтори свой успех,
управляя персонажем другой расы, класса и ранга. Собери полную коллекцию достижений!'''
